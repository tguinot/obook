...
orderbook_feeder = Service(name='OrderbookFeeder', port=0, address='/shm_abc', instrument='ETHUSD', exchange='BinanceUS')
orderbook_feeder.save()
orderbook_feeder = Service(name='OrderbookFeeder', port=0, address='/shm_hyu', instrument='BTC/USD', exchange='FTX')
orderbook_feeder.save()
orderbook_feeder = Service(name='OrderbookFeeder', port=0, address='/shm_koi', instrument='ETH/USD', exchange='FTX')
orderbook_feeder.save()
